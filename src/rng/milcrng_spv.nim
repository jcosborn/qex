...
# RNG from MILC version 6 ~~~~~ MODIFIED FOR PAULI-VILLARS CODE
...
#[ For sampling from uniform distribution ]#
...
#[ For sampling from Gaussian distribution ]#
