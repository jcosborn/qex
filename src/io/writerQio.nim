...
const defFileMd = "<?xml version=\"1.0\"?><note>generated by QEX</note>"
template newWriter*[V: static[int]](l: Layout[V]; fn: string, md=defFileMd): auto =
...
const defRecMd = "<?xml version=\"1.0\"?><note>lattice field</note>"
...
proc write*(wr: var Writer; v: Field; md=defRecMd; prec="") =
  var f = @[ v[0].addr ]
